<div class="carousel-wrapper container py-3">
    <div id="bannerCarousel" class="carousel slide carousel-dark" data-bs-ride="carousel" data-bs-touch="true">
        ...
        <button class="carousel-control-next" style="width: 5%;" type="button" data-bs-target="#bannerCarousel" data-bs-slide="next">
            <span style="width: 3rem; height: 3rem; background-color: #ccc; filter: unset;" class="carousel-control-next-icon" aria-hidden="true"></span>
        </button>
    </div>
</div>