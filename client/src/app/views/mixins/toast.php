...
function renderToast($msg = 'Thông báo', $show = false, $isTop = false, $isError = false)
{
    ...
    echo "<div id='toast' data-bs-autohide='true' class='toast $showClass $bgClass position-fixed text-white border-0 py-2 px-3' style='z-index: 9999; $placement; right: 24px' role='alert' aria-live='assertive' aria-atomic='true'>
        <div class='d-flex'>
