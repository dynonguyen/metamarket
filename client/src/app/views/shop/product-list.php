        ...
        <div class='row g-4'>
            ...
            <?php } else {
                ...
                foreach ($productDetailList as $p) {
                    ...
                    renderProductModal($catalogs, $pDataProduct->_id, $pDataProduct->code, $pDataProduct->name, $pDataProduct->avt, $pDataProduct->price, $pDataProduct->discount, $pDataProduct->unit, $pDataProduct->mfg, $pDataProduct->exp, $pDataProduct->stock, $pDataProductDetail->origin, $pDataProductDetail->brand, $pDataProductDetail->photos, $pDataProductDetail->desc, $pDataProduct->catalogId, $pDataProduct->categoryId);
                }
